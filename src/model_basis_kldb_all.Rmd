---
title: "KldB: Convergence tests under baseline model for different HMC hyperparameters"
output: pdf_document
---
...
# First:
### Keep only two most common classes: "7" and "8"
...
```{r Posterior summaries and analysis - BASIS, warning=FALSE, message=FALSE, eval=FALSE}  
# library(dplyr)
# library(posterior)
# library(ggplot2)
# library(reshape2)
...
# 
# qz_df <- as.data.frame(qz_mean)
# colnames(qz_df) <- paste0("p_", kldb_levels)
# qz_df$item_id <- item_ids
# 
# # MAP, both as index and as original label
# qz_df$map_class_idx   <- max.col(qz_df[paste0("p_", kldb_levels)], ties.method = "first")
# qz_df$map_class_label <- kldb_levels[qz_df$map_class_idx]
# 
# # Join back to items
...
# 
# library(ggplot2)
# qz_df$max_p <- apply(qz_df[paste0("p_", kldb_levels)], 1, max)
# 
